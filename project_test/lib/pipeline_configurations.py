...
class PipelineConfiguration(object):
    ...
    TEST_SHOWS_CODING_PLANS = [
       CodingPlan(raw_field="internet_working_raw",
                ...
                coda_filename="internet_coded.json",
        ...
        CodingPlan(raw_field="water_filter_raw",
                ...
                coda_filename="water_coded.json",
        ...
        CodingPlan(raw_field="waste_disposal_raw",
                time_field="sent_on",
                coda_filename="waste_coded.json",
    ...
    SURVEY_CODING_PLANS = [
        ...
        CodingPlan(raw_field="gender_raw",
                ...
                coda_filename="gender_coded.json",
        ...
        CodingPlan(raw_field="client_region_raw",
                ...
                coda_filename="location_coded.json",
