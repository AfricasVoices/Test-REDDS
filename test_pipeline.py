...
from project_test import AnalysisFile
...
if __name__ == "__main__":
    ...
    parser.add_argument("icr_output_dir", metavar="icr-output-dir",
                        help="Directory to write CSV files to, each containing n messages and message ids for use " 
    ...
    waste_disposal_input_path = args.waste_disposal_input_path
    ...
    shows_paths = [water_filter_input_path, internet_working_input_path, waste_disposal_input_path]
